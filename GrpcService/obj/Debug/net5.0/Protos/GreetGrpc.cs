...
namespace GrpcService {
  ...
  public static partial class Greeter
  {
    ...
    static readonly grpc::Method<global::GrpcService.HelloRequest, global::GrpcService.HelloReply> __Method_PostHello = new grpc::Method<global::GrpcService.HelloRequest, global::GrpcService.HelloReply>(
        grpc::MethodType.Unary,
        __ServiceName,
        "PostHello",
        __Marshaller_greet_HelloRequest,
    ...
    public abstract partial class GreeterBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::GrpcService.HelloReply> PostHello(global::GrpcService.HelloRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class GreeterClient : grpc::ClientBase<GreeterClient>
    {
      ...
      public virtual global::GrpcService.HelloReply PostHello(global::GrpcService.HelloRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return PostHello(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::GrpcService.HelloReply PostHello(global::GrpcService.HelloRequest request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_PostHello, null, options, request);
      }
      public virtual grpc::AsyncUnaryCall<global::GrpcService.HelloReply> PostHelloAsync(global::GrpcService.HelloRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return PostHelloAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncUnaryCall<global::GrpcService.HelloReply> PostHelloAsync(global::GrpcService.HelloRequest request, grpc::CallOptions options)
      {
    ...
    public static grpc::ServerServiceDefinition BindService(GreeterBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          ...
          .AddMethod(__Method_PostHello, serviceImpl.PostHello).Build();
    }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GreeterBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_PostHello, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcService.HelloRequest, global::GrpcService.HelloReply>(serviceImpl.PostHello));
    }
